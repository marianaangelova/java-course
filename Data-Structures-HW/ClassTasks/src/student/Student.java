...
public class Student {
	...
	public void addSubjectMark(String subject, Double newMark){
		if (studentsMarks.containsKey(subject)) {
			studentsMarks.get(subject).add(newMark);
		}
		else {
			System.out.println("Iveta doesn't study such subject!");
		}
