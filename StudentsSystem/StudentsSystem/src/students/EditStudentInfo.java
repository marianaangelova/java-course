...
public EditStudentInfo(Student student) {
	...
	formattedMathTextField .setValue(mainStudent.getMathematicsMarks());
	...
	btnAddStudent.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			if (formattedNameTextField.getText() == null || formattedNameTextField.getText().equals("")) {
				...
				student.setMathematicsMarks(mathematic);
				student.setEnglishMarks(english);
				student.setEconomicsMarks(economics);
				student.setLowFundMarks(low);
				student.setInformaticsMarks(informatics);
				setVisible(false);
			}
		}
	});
