		...
		btnAddStudent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (formattedNameTextField.getText() == null || formattedNameTextField.getText().equals("")) {
					...
					mainStudent.setMathematicsMarks(mathematicsMarks);
					mainStudent.setEnglishMarks(englishMarks);
					mainStudent.setEconomicsMarks(economicsMarks);
					mainStudent.setLowFundMarks(lowFundMarks);
					mainStudent.setInformaticsMarks(informaticsMarks);
					mainStudent.setMarks(marks);
					mainStudent.setAverageMark(averageMark);
					setVisible(false);
				}
			}
		});
